...
# AdjnL: X<lemma:nada> X<lemma:$NEG>
# Add: pol:pos
(@temp) = ($listTags =~ /($X${l}lemma:nada\|${r})($X${l}lemma:$NEG\|${r})/g);
$Rel =  "AdjnL";
DepHead($Rel,"",@temp);
$listTags =~ s/($X${l}lemma:nada\|${r})($X${l}lemma:$NEG\|${r})/$2/g;
Add("DepHead","pol:pos",@temp);

# AdjnL: X<lemma:nada> X<lemma:$POS>
# Add: pol:neg
(@temp) = ($listTags =~ /($X${l}lemma:nada\|${r})($X${l}lemma:$POS\|${r})/g);
$Rel =  "AdjnL";
DepHead($Rel,"",@temp);
$listTags =~ s/($X${l}lemma:nada\|${r})($X${l}lemma:$POS\|${r})/$2/g;
Add("DepHead","pol:neg",@temp);
