...
# CprepR: ADJ<lemma:fácil> PRP<lemma:de> VERB<lemma:$NEG>
# Add: pol:neg
(@temp) = ($listTags =~ /($ADJ${l}lemma:fácil\|${r})($PRP${l}lemma:de\|${r})($VERB${l}lemma:$NEG\|${r})/g);
$Rel =  "CprepR";
HeadRelDep($Rel,"",@temp);
$listTags =~ s/($ADJ${l}lemma:fácil\|${r})($PRP${l}lemma:de\|${r})($VERB${l}lemma:$NEG\|${r})/$1/g;
Add("HeadRelDep","pol:neg",@temp);

# Single: [ADJ<lemma:difícil>] [PRP<lemma:de>] VERB<lemma:$NEG>
# Add: pol:pos
# NEXT
# CprepR: ADJ<lemma:difícil> PRP<lemma:de> VERB<lemma:$NEG>
# Add: pol:pos
(@temp) = ($listTags =~ /(?:$ADJ${l}lemma:difícil\|${r})(?:$PRP${l}lemma:de\|${r})($VERB${l}lemma:$NEG\|${r})/g);
$Rel =  "Single";
Head($Rel,"",@temp);
Add("Head","pol:pos",@temp);
(@temp) = ($listTags =~ /($ADJ${l}lemma:difícil\|${r})($PRP${l}lemma:de\|${r})($VERB${l}lemma:$NEG\|${r})/g);
$Rel =  "CprepR";
HeadRelDep($Rel,"",@temp);
$listTags =~ s/($ADJ${l}lemma:difícil\|${r})($PRP${l}lemma:de\|${r})($VERB${l}lemma:$NEG\|${r})/$1/g;
...
$Rel =  "TermR";
HeadDep($Rel,"",@temp);
$listTags =~ s/($X${l}lemma:$NEG\|${r})($X$a|$PUNCT$a)/$1/g;
...
$Rel =  "TermR";
HeadDep($Rel,"",@temp);
$listTags =~ s/($X${l}lemma:$POS\|${r})($X$a|$PUNCT$a)/$1/g;
