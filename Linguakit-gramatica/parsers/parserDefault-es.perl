...
# Single: [X<lemma:difícil|complicado>] [PRP<lemma:de>] VERB<lemma:$POS>
# Add: pol:neg
# NEXT
# CprepR: X<lemma:difícil|complicado> PRP<lemma:de> VERB<lemma:$POS>
(@temp) = ($listTags =~ /(?:$X${l}lemma:(?:difícil|complicado)\|${r})(?:$PRP${l}lemma:de\|${r})($VERB${l}lemma:$POS\|${r})/g);
$Rel =  "Single";
Head($Rel,"",@temp);
Add("Head","pol:neg",@temp);
(@temp) = ($listTags =~ /($X${l}lemma:(?:difícil|complicado)\|${r})($PRP${l}lemma:de\|${r})($VERB${l}lemma:$POS\|${r})/g);
$Rel =  "CprepR";
HeadRelDep($Rel,"",@temp);
$listTags =~ s/($X${l}lemma:(?:difícil|complicado)\|${r})($PRP${l}lemma:de\|${r})($VERB${l}lemma:$POS\|${r})/$1/g;

# Single: [X<lemma:difícil|complicado>] [PRP<lemma:de>] VERB<lemma:$NEG>
# Add: pol:pos
# NEXT
# CprepR: X<lemma:difícil|complicado> PRP<lemma:de> VERB<lemma:$NEG>
# Add: pol:pos
(@temp) = ($listTags =~ /(?:$X${l}lemma:(?:difícil|complicado)\|${r})(?:$PRP${l}lemma:de\|${r})($VERB${l}lemma:$NEG\|${r})/g);
$Rel =  "Single";
Head($Rel,"",@temp);
Add("Head","pol:pos",@temp);
(@temp) = ($listTags =~ /($X${l}lemma:(?:difícil|complicado)\|${r})($PRP${l}lemma:de\|${r})($VERB${l}lemma:$NEG\|${r})/g);
$Rel =  "CprepR";
HeadRelDep($Rel,"",@temp);
$listTags =~ s/($X${l}lemma:(?:difícil|complicado)\|${r})($PRP${l}lemma:de\|${r})($VERB${l}lemma:$NEG\|${r})/$1/g;
Add("HeadRelDep","pol:pos",@temp);
